...
namespace CountingSheep
{
    class Solution
    {
        public class Kata
        {
            public int lostSheep(IEnumerable<int> friday, IEnumerable<int> saturday, int total)
            {
    ...
    //As sheep are not coming in one flock, you will be given two arrays(one for each night) representing number of sheep as they were 
